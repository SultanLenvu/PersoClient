...
#define COMMAND_GETCURRENTBOXDATA_RESPONSE_SIZE 11
...
#define COMMAND_GETCURRENTTRANSPONDERDATA_RESPONSE_SIZE 9
#define COMMAND_GETTRANSPONDERDATA_RESPONSE_SIZE 9
