...
//===============================================================
#define USER_OPERATION_MAX_DURATION 20000
//===============================================================

/* Определения клиента */
//===============================================================
#define PERSO_SERVER_CONNECTION_WAITING_TIME 10000
...
#define DATA_BLOCK_MAX_SIZE (TRANSPONDER_FIRMWARE_SIZE * 2)
...
//===============================================================
#define TRANSPONDER_FIRMWARE_FILE_NAME \
  "data.bin"  // Расширение критически важно, оно обязательно должно быть .bin
#define TRANSPONDER_FIRMWARE_SIZE 131072

#define JLINK_COMMAND_SCRIPT_DEFAULT_NAME "JLinkScript.jlink"

#define TRANSPONDER_USER_DATA_START_ADDRESS "0x0801F000"
#define TRANSPONDER_USER_DATA_SIZE 4096
#define TRANSPONDER_USER_DATA_END_ADDRESS "0x0801FFFF"
